...
NewSoftSerial xbeeSerial(4, 3);
XBee xbee = XBee();
XBeeResponse response = XBeeResponse();

//broadcasts to transmitting XBEE
uint8_t payload[] = {0, 0};
TxStatusResponse txStatus = TxStatusResponse();
// Specify the address of the remote XBee (this is the SH + SL)
XBeeAddress64 addr64 = XBeeAddress64(0x0013a200, 0x4064bb7f);
Tx16Request tx = Tx16Request((0x0013a200, 0x4064bb7f), payload, sizeof(payload));
